<p align="left">
  <a href="./README.en.md">
    <img src="https://img.shields.io/badge/🌍%20Read%20in%20English-blue?style=for-the-badge" alt="Ler em inglês"/>
  </a>
</p>
...
- Para rodar o projeto no seu navegador ( LocalHost ) digite no terminal após o npm i: 
    ```bash
    npm run dev
    ```
